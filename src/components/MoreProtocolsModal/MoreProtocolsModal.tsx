					...
					<Row>
						<Col md={{ span: 8, offset: 2 }}>
							...
							<div className="mt-3 mb-3">
								<img
									src="/assets/images/resource/protocol/7.png"
									alt="Image"
								/>
							</div>
							<p className="mb-5">
								Aave is an open source and non-custodial
								protocol enabling the creation of money markets.
							</p>
						</Col>
					</Row>
							...
							<div className="pl-5 pr-5">
								...
								>
									<Tab eventKey="swap" title="Swap">
										Aave is an open source and non-custodial
										protocol enabling the creation of money
										markets. Users can earn interest on
