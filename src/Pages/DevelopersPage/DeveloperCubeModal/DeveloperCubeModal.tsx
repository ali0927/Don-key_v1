...
export const DeveloperCubeModal: React.FC<IDeveloperCubeModalProps> = (props) => {
    ...
    return (
        ...
        >
            <Modal.Header closeButton className="p-0">
                <Modal.Title id="contained-modal-title-vcenter"  as="p" className="d-flex align-items-center w-100">
                    <div className="mr-3">
                        {headerIcon}
                    </div>
                    <div className="title">
