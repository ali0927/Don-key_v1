...
export const DevelopersPage = () => {
  ...
  const handeChange = (name: keyof IDeveloperCubeProps) => (
              ...
              {open && (
                ...
                >
                  <form method="POST" onSubmit={handleSave}>
                    <Form.Group
                      controlId="namecube"
                      className="form-custom-group mb-5"
                    >
                      <Form.Label>Name cube</Form.Label>
                      <Form.Control
                        name="namecube"
                        value={state.nameCube}
                        required
                        onChange={handeChange("nameCube")}
                      />
                    </Form.Group>
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        required
                        onChange={handeChange("githublink")}
                      />
                    </Form.Group>
                    ...
                    <ButtonComponent
                      type="submit"
                      disabled={loading}
                      className="btnYellow w-100 btn-disabled"
                    >
                    ...
                    {resposne === "error" && (
                      <div className="mt-3 error">Please try again later.</div>
                    )}
                  </form>
                </DeveloperCubeModal>
              )}
