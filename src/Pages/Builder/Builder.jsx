	...
	padding: 10px;">
        <ul style="list-style: none;     padding-inline-start: 0px;">
          ...
          <li style="height: 66px;">
            ...
            <li style="height: 66px;">
              <img src="./pics/COMP.png" id="comp" draggable="true" ondragstart="drag(event)">
				</li>
              <li style="height: 66px;">
                <img src="./pics/CRV.png" id="crv" draggable="true" ondragstart="drag(event)">
				</li>
                <li style="height: 66px;">
                  <img src="./pics/AAVE.png" id="aave" draggable="true" ondragstart="drag(event)">
				</li>

                  <li style="height: 66px;">
                    <img src="./pics/HARVEST.png" id="harvest" draggable="true" ondragstart="drag(event)">
				</li>
                    <li style="height: 66px;">
                      <img src="./pics/UNISWAP.png" id="uniswap" draggable="true" ondragstart="drag(event)">
				</li>
			</ul>
		</div>
				...
				<a className="btn-close trigger" href="javascript:;"></a>
                      ...
                      <table>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>
                              <td colspan="2">
                                <button className="trigger" id="createAction">Create action</button>
                              </td>
                            </tr>
				</table>
			</div>
                    ...
                    <div className="panel" id="yfipanel">
                      ...
                      <div className="panel_header">
                        <button id="close" className="btn_close">X</button>

                        <h2 style="display: inline-block;">yEarn finance</h2>
                        <img style="display: inline-block;"
                          src="https://cdn.cryptotips.eu/wp-content/uploads/2020/09/yearn-finance-review-230x230.png" width="50">
                          <div>
                        ...
                        <div className="panel_scroll">
                          ...
                          <ul>
                            <li>
                              <div className="poolImage"><img src="https://yearn.finance/static/media/cDAIcUSDC-logo.6640e9ec.png"
                                width="40" /></div>
                            ...
                            <li>
                              <div className="poolImage"><img src="https://yearn.finance/static/media/3Crv-logo.a29563db.png"
                                width="40" /></div>
                            ...
                            <li>
                              <div className="poolImage"><img src="https://yearn.finance/static/media/musd3CRV-logo.88ee8341.png"
                                width="40" /></div>
                            ...
                            <li>
                              <div class="poolImage"><img src="https://yearn.finance/static/media/crvBUSD-logo.5008aa36.png"
                                width="40" /></div>
                            ...
                            <li>
                              <div className="poolImage"><img src="https://yearn.finance/static/media/crvBTC-logo.8ffd61ac.png"
                                width="40" /></div>
                        ...
                        <div className="panel_footer">
                          ...
                          <input type="submit" class="btn btn_save" value="Save">
		</div>
                        ...
                        <div className="panel" id="cmppanel">
                          ...
                          <div className="panel_header">
                            ...
                            <img style="display: inline-block;"
                              src="https://pbs.twimg.com/profile_images/1154294327931068416/kKm_IHGE_400x400.png" width="50">
                              <div>
                            ...
                            <div className="panel_scroll">
                              ...
                              <ul>
                                <li>
                                  <div className="poolImage"><img src="https://app.compound.finance/images/asset_BAT.svg" width="40" />
                                  </div>
                                  <div style="display: inline-block; vertical-align: top;">BAT</div>
                                  <div style="display: block;margin-left: 44px;margin-top: -21px;">
                                  </div>
                                  <div className="btnControl actionBtn">
                                    <div className="btn">
                                ...
                                <li>
                                  <div className="poolImage"><img src="https://app.compound.finance/images/asset_COMP.svg" width="40" />
                                  </div>
                                ...
                                <li>
                                  <div className="poolImage"><img src="https://app.compound.finance/images/asset_DAI.svg" width="40" />
                                  </div>
                                  <div style="display: inline-block; vertical-align: top;">DAI</div>
                                  <div style="display: block;margin-left: 44px;margin-top: -21px;">
                                          APY: 5.56%
                                ...
                                <li>
                                  <div className="poolImage"><img src="https://app.compound.finance/images/asset_UNI.svg" width="40" />
                                  </div>
